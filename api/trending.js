...
export default async function handler(req, res) {
  ...
  try {
    ...
    // The RapidAPI plan in use is rate-limited, so a live failure shouldn't
    // leave the homepage grid empty - fall back to the last successful
    // result for this rotation's keyword instead.
